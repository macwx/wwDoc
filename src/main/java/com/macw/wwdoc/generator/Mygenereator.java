package com.macw.wwdoc.generator;
 ...
 * @author Macw
 * @version 1.0
 * @date 2019/12/29 22:46
 */
public class Mygenereator {
...
//        gc.setSwagger2(true);
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Ent处ity 设置了前后缀、此注意 xml 的名称会跟着发生变化！！
        ...
        // strategy.setSuperEntityClass("com.macw.BaseEntity");
